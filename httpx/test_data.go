...
type testPostFormResponse struct {
	UserId int    `json:"userId,string"` // jsonplaceholder bug
	Id     int    `json:"id"`
	Title  string `json:"title"`
	Body   string `json:"body"`
}
...
var testComments = []testComment{}
var testPosts = []testPost{}

func init() {
	err := json.Unmarshal([]byte(testCommentJson), &testComments)
	if err != nil {
		panic(err)
	}
